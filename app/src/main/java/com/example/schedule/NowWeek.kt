...
class NowWeek : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val savedColorText = loadSelectedColorText()
        applyColorToText(savedColorText)
        ...
        val SelectColorText = findViewById<Button>(R.id.SelectColorTextView)
        SelectColorText.setOnClickListener(){
            showColorPickerText()
        }
        ...
        ColorTextView = sharedPref.getInt("COLOR_TEXT_VIEW", 0)
        changeTextColorView()
        val changeTextColorView = findViewById<Button>(R.id.changeTextColorView)
        changeTextColorView.setOnClickListener(){
            if(ColorTextView==0){
                ColorTextView=1
                changeTextColorView()
                saveColorTextView()
    ...
    private fun saveSelectedColorText(color: Int) {
        val sharedPreferences = getSharedPreferences("MyPrefs", Context.MODE_PRIVATE)
        val editor = sharedPreferences.edit()
        editor.putInt("selected_color_text", color)
        editor.apply()
    }

    private fun loadSelectedColorText(): Int {
        val sharedPreferences = getSharedPreferences("MyPrefs", Context.MODE_PRIVATE)
        // Retrieve the color value as an integer
        return sharedPreferences.getInt("selected_color_text", Color.parseColor("#A1000000"))
    }

    private fun applyColorToText(color: Int) {
        val cornerRadiusDp = 16 // радиус скругления углов в dp
        ...
        for (textID in textIds) {
            ...
            drawable.cornerRadius = cornerRadiusPx.toFloat()
    ...
    private fun showColorPickerText(){
       val colorPicker = ColorPickerDialog(
           ...
           object : ColorPickerDialog.OnColorPickerListener {
               ...
               override fun onOk(dialog: ColorPickerDialog?, colorPicker: Int) {
                   ...
                   saveSelectedColorText(colorPicker)
                   applyColorToText(colorPicker)
               }
           })
       colorPicker.show()
   }
    ...
    private fun applyColorToAllViews(color: Int) {
        ...
        val buttonIds = arrayOf(
            ...
            R.id.Back2,
            R.id.Back3,
            R.id.SelectColorTextView,
            R.id.changeTextColorView
        )
    ...
    private fun applyColorToView(view: Button, color: Int) {
        ...
        pressed.setColor(Color.parseColor("#B3616161"))
    ...
    fun changeColorText() {
        ...
        val buttons = listOf(
            ...
            R.id.Back1, R.id.Back2, R.id.Back3, R.id.SelectColorTextView, R.id.changeTextColorView
        )
    ...
    fun changeTextColorView() {
        val color = if (ColorTextView == 0) Color.BLACK else Color.WHITE
        ...
        textView.forEach { buttonId ->
            findViewById<TextView>(buttonId).setTextColor(color)
        }
    }
    ...
    private fun saveColorTextView() {
        val editor = sharedPref.edit()
        editor.putInt("COLOR_TEXT_VIEW", ColorTextView)
        editor.apply()
    }
